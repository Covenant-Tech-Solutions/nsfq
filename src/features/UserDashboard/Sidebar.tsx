...
const Sidebar = () => {
  ...
  return (
    <>
      <div className={cn(
        "bg-primary/5 col-span-12 flex w-full items-center justify-between rounded-lg p-3 lg:col-span-3",
        path === "/" ? "lg:hidden" : "hidden" // Hide on mobile for all pages except home
      )}>
        {!open ? (
          <Button
      ...
      <div className={cn(
        "relative col-span-12 lg:col-span-3",
        path === "/" ? "" : "hidden lg:block" // Hide on mobile for all pages except home
      )}>
        <ul
          className={cn(
